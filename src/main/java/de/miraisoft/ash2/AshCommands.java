...
public class AshCommands {
	...
	public static void registerCommands() {
		...
		commandDispatcher.register(ClientCommandManager.literal("toggleash2").executes(context -> {
			config.showHud = !config.showHud;
			AshMod.configManager.save();
			return 1;
		}));

		commandDispatcher.register(ClientCommandManager.literal("resetash2").executes(context -> {
